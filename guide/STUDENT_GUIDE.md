...
1. **Snowflake Trial Account** -- Sign up at [signup.snowflake.com](https://signup.snowflake.com/). Choose **Enterprise Edition**. Any cloud provider and region works.
...
5. **Warehouse** -- Create one if needed: `CREATE WAREHOUSE DQ_LAB_WH WAREHOUSE_SIZE='XSMALL';`
...
> **Note:** Cortex AI requires cross-region inference in some regions (any region outside the US). This was enabled in Module 0. If you get errors, verify with: `SHOW PARAMETERS LIKE 'CORTEX_ENABLED_CROSS_REGION' IN ACCOUNT;`
